...
public class ObjectInteract : MonoBehaviour {
    ...
    private void rotate()
    {
        ...
        //float angleBetween = Vector3.Angle(beginInteractVector, currentInteractVector) * -Mathf.Sign(Vector3.Cross(beginInteractVector, currentInteractVector).z);
        //debugInfo.outsideText = "angleBetween: " + angleBetween + ", current angle: " + gameObject.transform.rotation.z;
        //Debug.DrawRay(beginInteractVector + gameObject.transform.position, (endPoint) * 3, Color.yellow);

        // gameObject.transform.Rotate(0,0, angleBetween * Time.deltaTime);
    }
}
